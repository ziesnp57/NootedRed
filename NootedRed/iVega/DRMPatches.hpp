...
class DYLDPatch {
    ...
    const size_t size {0};          // 补丁大小
    const char *comment {nullptr};   // 补丁说明
...
class DRMPatches {
    ...
    static void wrapCsValidatePage(vnode *vp, memory_object_t pager, memory_object_offset_t page_offset,
            const void *data, int *validated_p, int *tainted_p, int *nx_p);  // 页面验证包装函数
};
 ...
 * 48 8B 86 60 04 00 00 8B 40 0C 83 F8 07 77
 */
static const UInt8 kVAFactoryCreateGraphicsEngineOriginal[]     = {
	0x48, 0x8B, 0x86, 0x60, 0x04, 0x00, 0x00, 0x8B, 0x40, 0x0C, 0x83, 0xF8, 0x07, 0x77, 0x00};
...
static const UInt8 kVAFactoryCreateGraphicsEnginePatched[]      = {
	0xC7, 0xC0, 0x04, 0x00, 0x00, 0x00, 0x66, 0x90, 0x66, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00};
...
//! Ditto
//! 48 8B 86 60 04 00 00 8B 40 0C 8D 48 FF 83 F9 02 72 00 8D 48 FD 83 F9 02
//! 48 8B 86 60 04 00 00 8B 40 0C 8D 48 FF 83 F9 02 72 xx 8D 48 FD 83 F9 02 xx=22,0F
static const UInt8 kVAFactoryCreateGraphicsEngineVenturaOriginal[] = {
	0x48, 0x8B, 0x86, 0x60, 0x04, 0x00, 0x00, 0x8B, 0x40, 0x0C, 0x8D, 0x48, 0xFF, 0x83, 0xF9, 0x02, 0x72, 0x00, 0x8D, 0x48, 0xFD, 0x83, 0xF9, 0x02};
static const UInt8 kVAFactoryCreateGraphicsEngineVenturaOriginalMask[] = {
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
static const UInt8 kVAFactoryCreateGraphicsEngineVenturaPatched[]      = {
	0xC7, 0xC0, 0x04, 0x00, 0x00, 0x00, 0x66, 0x90, 0x66, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
static const UInt8 kVAFactoryCreateVPVenturaOriginal[]     = {0x8D, 0x46, 0xFF, 0x83, 0xF8, 0x02, 0x72, 0x1F, 0x8D, 0x46,
    0xFD, 0x83, 0xF8, 0x02, 0x73, 0x2E, 0xBF, 0x00, 0x00, 0x00, 0x00, 0xE8, 0x00, 0x00, 0x00, 0x00};
static const UInt8 kVAFactoryCreateVPVenturaOriginalMask[] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF,
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0xFF, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00};
static const UInt8 kVAFactoryCreateVPVenturaPatched[]      = {0x00, 0x00, 0x00, 0xBE, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
static const UInt8 kVAFactoryCreateVPVenturaPatchedMask[]  = {0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
...
static const UInt8 kVAFactoryCreateImageBltOriginal[] = {
	0x48, 0x89, 0xF7, 0x48, 0x8B, 0x86, 0x60, 0x04, 0x00, 0x00, 0x8B, 0x40, 0x0C
};
static const UInt8 kVAFactoryCreateImageBltMask[] = {
	0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
};
static const UInt8 kVAFactoryCreateImageBltPatched[] = {
	0x48, 0x89, 0xF7, 0x48, 0xB8, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
};
